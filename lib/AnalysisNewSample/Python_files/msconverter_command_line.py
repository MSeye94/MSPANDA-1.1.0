...
def convert_to_mzML(input_directory,output_directory):
  param_covert = open("lib/AnalysisNewSample/Parameters/convert_raw_data_to_mzML_centroid.txt", 'r')
  quote ="\""
  ...
  with open("lib/AnalysisNewSample/cmd/convert_raw_data_to_mzML_centroid.bat", 'w') as temp_file:
