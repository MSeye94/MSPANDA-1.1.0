  ...
  fluidRow(column(
    ...
    The MS-PANDA tool consists of two parts:",
      tags$ol(
        tags$li(
          a("New reference map: "),
          "allows the development of a new peptide or metabolite reference map of a given biological liquid.
      This reference map is then used to identify a set of intensity-stable particles."
        ),
        
        tags$li(
          a("Analysis new sample: "),
          "a second part that allows to detect,
      match and normalize the peptides or metabolites of a new sample on the reference map.
        "
        )
      )
    )
